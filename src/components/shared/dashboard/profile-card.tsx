...
const ProfileCard = (props: Props) => {
  return (
    <Card className={`px-6 py-6 w-full flex flex-row gap-3 shadow-sm rounded-2xl items-center`}>
        <Image src={"/assets/icons/profile-image.png"} alt="Profile Image" width={100} height={100} className='rounded-full border border-secondary-gold h-[100px] w-[100px] object-cover'></Image>
        <div>
